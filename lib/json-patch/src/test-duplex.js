...
describe("JSON-Patch-Duplex", function () {
  ...
  describe('callback', function() {
    ...
    it("should remove window events listeners after object stops being observed", function () {
      ...
      var observer = jsonpatch.observe(obj, callback);
